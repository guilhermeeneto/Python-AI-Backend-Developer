...
def transferir(contas):
    origem = int(input("Informe o número da conta de origem: "))
    destino = int(input("Informe o número da conta de destino: "))

    conta_origem = None
    conta_destino = None

    for conta in contas:
        if conta["numero_conta"] == origem:
            conta_origem = conta
        elif conta["numero_conta"] == destino:
            conta_destino = conta
